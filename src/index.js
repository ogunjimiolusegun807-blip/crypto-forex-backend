...
const corsOptions = {
  origin: ['https://crypto-forex-three.vercel.app', 'https://www.eloninvestmentbroker.com'], // Allow both domains
  credentials: true,
...
app.use((req, res, next) => {
  const allowedOrigins = ['https://crypto-forex-three.vercel.app', 'https://www.eloninvestmentbroker.com'];
